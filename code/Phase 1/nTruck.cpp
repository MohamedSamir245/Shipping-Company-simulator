...
int nTruck::Checkup_Duration = 0;

nTruck::nTruck ( float TC, int id, int NJ, Time DI, float S, int D ) :Truck ( TC, id, NJ, DI , S)
{
...
void nTruck::SetEndCheckupTime ( Time CH_Time )
{
	End_Checkup_Time = CH_Time;
}

Time nTruck::GetEndCheckupTime ( ) const
{
...
void nTruck::SetCheckupDuration(int n)
{
	Checkup_Duration = n;
}

int nTruck::GetCheckupDuration() const
{
	return Checkup_Duration;
}

void nTruck::setcdtforcargos(Time t)
{
